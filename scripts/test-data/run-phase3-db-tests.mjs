...
if (process.env.NODE_ENV === "production" || process.env.VERCEL_ENV === "production") {
  throw new Error("Les tests Phase 3 refusent un environnement de production.");
}
const parsed = new URL(databaseUrl);
if (!parsed.hostname.endsWith(".neon.tech")) {
  throw new Error("La base Phase 3 doit être la Neon de développement/test autorisée.");
}
