...
if (process.env.NODE_ENV === "production" || process.env.VERCEL_ENV === "production") {
  throw new Error("Les tests Phase 5 refusent un environnement de production.");
}
const parsed = new URL(databaseUrl);
if (!parsed.hostname.endsWith(".neon.tech")) {
  throw new Error("La base Phase 5 doit être la Neon de développement/test autorisée.");
}
...
const result = spawnSync(
  ...
  [
    ...
    "run",
    "tests/phase5-identity-media-db.test.ts",
    "--maxWorkers=1",
    "--no-file-parallelism",
    "--testTimeout=60000",
    "--hookTimeout=90000",
