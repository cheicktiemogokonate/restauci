  ...
  if (process.env.E2E_TEST === "true") {
    ...
    const pool =
      ...
      new Pool({
        ...
        max:
          process.env.ALLOW_DEVELOPMENT_DB_TESTS === "true" ? 2 : 5,
        connectionTimeoutMillis:
          process.env.ALLOW_DEVELOPMENT_DB_TESTS === "true" ? 30_000 : 15_000,
        idleTimeoutMillis:
          process.env.ALLOW_DEVELOPMENT_DB_TESTS === "true" ? 60_000 : 10_000,
        keepAlive:
