...
import type { CreateMenuDishAction } from "./action-types";
...
interface PlatFormWizardProps {
  ...
  action: CreateMenuDishAction;
}

export default function PlatFormWizard({ categories, action }: PlatFormWizardProps) {
  ...
  const handleImageChange = (image: { assetId: string; url: string } | null) => {
    setFormData((prev) => ({
      ...prev,
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <StepCategorie
                ...
                onCategoryChange={(categorieId) =>
                  setFormData((current) => ({ ...current, categorieId }))
                }
