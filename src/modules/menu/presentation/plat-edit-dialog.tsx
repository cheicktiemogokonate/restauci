        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid gap-4 sm:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
            <div>
              ...
              <div className="relative">
                <Input
                  value={form.prix}
                  onChange={(prix) =>
                    setForm((prev) => ({ ...prev, prix }))
                  }
                  classNames={{ field: inputCls, input: "pr-14" }}
                  required
                />
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(categorieId) =>
                  setForm((prev) => ({ ...prev, categorieId }))
                }
              >
          ...
          <div className="flex items-center justify-between rounded-xl border border-zinc-200 px-4 py-3">
            ...
            <Switch
              ...
              ariaLabel="Rendre le plat disponible"
