"use client";
import type { PublicRestaurantDTO as Restaurant } from "../../contracts";
      ...
      <div className="min-h-screen w-full overflow-hidden bg-linear-to-t from-black via-black/50 to-black/20">
        {restaurant.banniereUrl ? (
          <Image
            ...
            className="h-screen w-full scale-105 object-cover opacity-85 duration-1000 select-none animate-pulse-slow"
          ...
          <div
            className="h-screen w-full bg-[radial-gradient(circle_at_70%_20%,rgba(52,211,153,0.24),transparent_35%),linear-gradient(145deg,#052e24,#111827_65%)]"
            aria-hidden="true"
          />
        )}
