...
import type { ResidenceOnboardingActions } from "./action-types";
...
export function ResidenceOnboardingWizard({
  ...
  actions: ResidenceOnboardingActions;
}) {
  ...
  async function uploadPhoto(file: File | undefined) {
    ...
    try {
      ...
      updateDraft({
        photos: [...draft.photos, { assetId: payload.assetId, url: payload.url, altText: draft.title || null }],
      });
    } catch (error) {
