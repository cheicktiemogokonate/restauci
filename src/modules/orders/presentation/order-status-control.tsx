// Contrôle de statut du domaine Orders.
"use client";
...
interface OrderStatusMenuProps {
  ...
  onUpdateStatus: (commandeId: string, statut: Statut) => Promise<void>;
}
...
export function OrderStatusMenu({
  ...
  const handleSelect = (statut: Statut) => {
    ...
    startTransition(async () => {
      try {
        await onUpdateStatus(commandeId, statut);
  ...
  const handleConfirmCancel = () => {
    ...
    startTransition(async () => {
      try {
        await onUpdateStatus(commandeId, pendingStatus);
