...
// Espace opérationnel du domaine Orders.
              ...
              <div>
                <div className="mb-5 flex flex-col gap-3 sm:flex-row sm:items-center">
                  <div className="w-full sm:max-w-md">
                    <Input
                      id="history-search"
                      aria-label="Rechercher une commande terminée"
                      leftIcon={<Search />}
                      value={historySearch}
                  ...
                  >
                    <SelectTrigger ariaLabel="Filtrer par statut" className="h-10 w-full sm:w-40">
                  ...
                  >
                    <SelectTrigger ariaLabel="Filtrer par type" className="h-10 w-full sm:w-40">
