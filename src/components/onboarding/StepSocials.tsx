...
import { Share2, Link2, Sparkles, Check, RefreshCw } from "lucide-react";
...
export default function StepSocials({ data, updateData, onNext, onPrev }: StepSocialsProps) {
  ...
  const INTEGRATIONS: IntegrationTile[] = [
    {
      ...
      description: "Affichez vos plus belles assiettes et liez vos stories à votre menu.",
    ...
    },
    {
      id: "facebook",
      name: "Facebook Page",
      description: "Synchronisez vos posts et facilitez les réservations directes.",
    ...
    },
    {
      ...
      description: "Améliorez votre visibilité locale sur les moteurs et cartes Google.",
    ...
    },
    {
      id: "tripadvisor",
      name: "TripAdvisor",
      description: "Affiliez vos avis pour attirer une clientèle touristique premium.",
      placeholder: "https://tripadvisor.fr/Restaurant_Review...",
      iconBg: "bg-emerald-50 text-emerald-800 border-emerald-100",
      logoSvg: (
        <svg className="w-5 h-5 fill-current text-emerald-700" viewBox="0 0 24 24">
  ...
  const handleSimulateConnection = (id: keyof SocialLinks, placeholder: string) => {
    ...
    <div className="flex-1 max-w-4xl p-8 lg:p-12 overflow-y-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-sm text-gray-500 mt-2 font-sans">
          Liez les comptes officiels de votre restaurant pour activer les réservations sur vos canaux et enrichir votre page client autonome.
        </p>
      </div>
            ...
            return (
              <div
                ...
                className={`bg-white border rounded-2xl p-5 shadow-xs transition-all duration-300 ${
                  isConnected ? "border-brand-100 ring-2 ring-brand-50/50" : "border-gray-100 hover:border-gray-250 hover:shadow-sm"
                }`}
              >
                <div className="flex items-start justify-between">
                  <div className="flex items-start space-x-3.5">
                    <div className={`w-10 h-10 rounded-xl flex items-center justify-center border ${integ.iconBg}`}>
                      {integ.logoSvg}
                    </div>
                    <div>
                      ...
                      <p className="text-[11px] text-gray-500 mt-1 leading-relaxed max-w-[200px]">
                        {integ.description}
                      </p>
                    </div>
                  </div>
                  ...
                  <button
                    type="button"
                    onClick={() => handleSimulateConnection(integ.id, integ.placeholder)}
                ...
                <div className="mt-4 pt-4 border-t border-gray-50">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      value={currentVal || ""}
                      onChange={(e) => handleInputChange(integ.id, e.target.value)}
                    />
                  </div>
                </div>
              </div>
        ...
        <div className="p-4 bg-emerald-50/50 border border-brand-100/30 rounded-xl flex items-center justify-between">
          <div className="flex items-center space-x-2.5">
            ...
            <span className="text-xs font-semibold text-gray-800">
              {Object.values(connectedState).filter(Boolean).length} comptes connectés au total.
            </span>
          </div>
