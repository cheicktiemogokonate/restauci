      ...
      <CardContent className="space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="relative h-[52px] w-[52px] rounded-full overflow-hidden border border-border/50">
              <Image
                src={avatar}
                alt={name}
                fill
            ...
            <div>
              ...
              <div className="flex items-center gap-1.5 mt-0.5">
                ...
                />
                <span className="text-[12px] text-[#2d7d46] font-medium">{statusInfo.label}</span>
              </div>
            </div>
          </div>
          <div className="flex gap-2">
            <Button variant="outline" size="icon" className="h-10 w-10 rounded-xl border-border/80 text-muted-foreground hover:text-foreground">
        ...
        <div className="grid grid-cols-3 gap-4 pt-4 border-t border-border/60">
          ...
          <div>
            <p className="text-[12px] text-muted-foreground mb-1">Type de véhicule</p>
            <p className="text-[14px] font-semibold">{vehicleType}</p>
          </div>
          <div>
            <p className="text-[12px] text-muted-foreground mb-1">Numéro de véhicule</p>
