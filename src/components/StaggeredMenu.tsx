...
type StaggeredMenuStyle = React.CSSProperties & {
  '--sm-accent'?: string;
};
  ...
  const buildOpenTimeline = useCallback(() => {
    ...
    if (itemEls.length) {
      ...
      if (numberEls.length) {
        tl.to(
          numberEls,
          { duration: 0.6, ease: 'power2.out', css: { '--sm-num-opacity': 1 }, stagger: { each: 0.08, from: 'start' } },
          itemsStart + 0.1
        );
      }
    }
  ...
  return (
    ...
    >
      <div
        ...
        style={accentColor ? ({ '--sm-accent': accentColor } as StaggeredMenuStyle) : undefined}
                    ...
                    <a
                      ...
                      onClick={(e) => {
                        ...
                        if (it.link.startsWith("#")) {
                          const targetId = it.link.slice(1);
