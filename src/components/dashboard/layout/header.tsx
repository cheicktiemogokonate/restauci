      ...
      {/* <div className="flex flex-1 items-center justify-center max-w-md mx-4">
        <div className="relative w-full">
          ...
          <Input
            ...
            className="w-full pl-9 pr-12 bg-muted/50 border-0 focus-visible:ring-1 focus-visible:brand-green"
          />
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant="ghost" className="flex items-center gap-2 px-2">
              ...
              <div className="flex item-center justify-center">
                <div className="hidden text-left md:block md:space-x-4">
          ...
          <DropdownMenuContent align="end" className="w-48">
            <DropdownMenuLabel>Mon Restaurant</DropdownMenuLabel>
            <DropdownMenuSeparator />
