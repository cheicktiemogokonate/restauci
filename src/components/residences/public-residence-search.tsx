    ...
    >
      <Field>
        ...
        <div className="relative">
          <MapPin className="pointer-events-none absolute left-3 top-1/2 size-4 -translate-y-1/2 text-emerald-700" />
          <Input
            id="residence-destination"
            value={destination}
            onChange={(event) => setDestination(event.target.value)}
            placeholder="Abidjan, Grand-Bassam…"
            className="h-16 pl-10"
            maxLength={100}
          />
        </div>
      </Field>
      ...
      <Field>
        ...
        <div className="relative">
          <Users className="pointer-events-none absolute left-3 top-1/2 size-4 -translate-y-1/2 text-emerald-700" />
          <Input
            id="residence-guests"
            type="number"
            min={1}
