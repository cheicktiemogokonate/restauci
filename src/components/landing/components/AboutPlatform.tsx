"use client";
import { Check, Tablet, Smartphone, ShieldCheck, Sparkles } from "lucide-react";
...
export default function AboutPlatform() {
  ...
  return (
    <section id="about" className="py-24 overflow-hidden relative bg-white">
      ...
      <div 
        className="absolute top-[30%] left-[-10%] w-[500px] h-[500px] pointer-events-none -z-10 animate-pulse duration-5000"
      ...
      <BackgroundDecoration 
        ...
        className="absolute top-10 right-[-140px] opacity-25"
        size={360}
      />
      <BackgroundDecoration 
        src="/backgrounds/herbs-outline.svg" 
        className="absolute bottom-20 left-[-100px] opacity-30"
        size={330}
      />
      <BackgroundDecoration 
        src="/backgrounds/cheese-outline.svg" 
        className="absolute bottom-[10%] right-[-100px] opacity-25"
        size={290}
      />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            >
              ...
              <h2 className="font-display font-extrabold text-3xl sm:text-4xl text-brand-dark tracking-tight leading-[1.1] mb-6">
                Une infrastructure complète, pensée pour les restaurateurs réels.
              </h2>
              <p className="text-sm sm:text-base text-brand-dark/80 leading-relaxed font-sans">
                Oubliez les papiers perdus, les erreurs de communication entre la salle et la cuisine, et les ruptures de stocks imprévues. RestauCI unifie vos opérations.
              </p>
            </motion.div>
            ...
            <div className="space-y-5">
              {points.map((point, index) => (
                <motion.div 
                  ...
                  viewport={{ once: true }}
                  transition={shouldReduceMotion ? undefined : { duration: 0.5, delay: index * 0.12 }}
                >
                  <div className="flex-shrink-0 w-6 h-6 rounded-full bg-brand-green/10 text-brand-green flex items-center justify-center mt-1">
          ...
          <div className="lg:col-span-7 relative flex justify-center py-8">
            ...
            <div className="absolute top-[20%] left-[30%] w-[300px] h-[300px] bg-brand-green/5 rounded-full blur-[80px] -z-10 pointer-events-none" />

            {/* Simulated Desktop/Tablet panel mockup */}
            <motion.div 
              className="bg-[#FAFBFA] w-full max-w-[520px] rounded-2xl border border-gray-200/50 p-2 shadow-2xl relative z-10 transition-transform hover:scale-[1.01] duration-300"
              initial={shouldReduceMotion ? undefined : { opacity: 0, scale: 0.95, y: 40 }}
              whileInView={shouldReduceMotion ? undefined : { opacity: 1, scale: 1, y: 0 }}
              viewport={{ once: true, margin: "-60px" }}
              transition={shouldReduceMotion ? undefined : { type: "spring", damping: 25, stiffness: 100, delay: 0.1 }}
            >
              <div className="bg-white rounded-xl overflow-hidden border border-gray-250/30">
                ...
                <div className="bg-gray-100/90 px-4 py-2.5 flex items-center justify-between border-b border-gray-200/50">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-[10px] font-mono font-bold text-brand-dark/60">RestauCI Terminal • Cuisine #1</span>
                  </div>
                ...
                <div className="p-4 space-y-3 bg-white">
                  ...
                  <div className="grid grid-cols-2 gap-2.5">
                    <div className="bg-gray-50/50 p-2.5 rounded-lg border border-gray-200/40">
                      <div className="flex justify-between items-center text-[10px] mb-1">
                        <span className="font-bold text-brand-dark/75">Table 8</span>
                        <span className="text-amber-600 font-bold font-mono">11 min</span>
                      </div>
                      <p className="text-xs text-brand-dark font-semibold truncate">1x Filet de Saumon</p>
                      <p className="text-xs text-brand-dark/60 truncate">1x Frites maison</p>
                      <span className="text-[9px] text-brand-dark/45 block mt-2 font-mono">Saisi par : Sarah L.</span>
                    </div>

                    <div className="bg-emerald-500/5 p-2.5 rounded-lg border border-emerald-555/15">
                      <div className="flex justify-between items-center text-[10px] mb-1">
                        <span className="font-bold text-brand-dark/75">Table 11</span>
                        <span className="text-emerald-600 font-bold font-mono">2 min</span>
                      </div>
                      <p className="text-xs text-brand-dark font-semibold truncate">2x Double Burgers</p>
                      <p className="text-xs text-brand-dark/60 truncate">1x Salade César</p>
                      <span className="text-[9px] text-emerald-600 block mt-2 font-bold font-sans">Prêt pour envoi</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-gray-50/50 p-3 rounded-lg border border-gray-200/40 flex justify-between items-center mt-3">
                    <div className="space-y-0.5 min-w-0 pr-2">
                      <span className="text-[10px] text-brand-dark/50 font-bold uppercase block">Débit Moyen</span>
                      <span className="text-xs sm:text-sm font-extrabold text-brand-dark truncate block">12.5 min par commande</span>
                    </div>
            ...
            <motion.div 
              className="absolute -bottom-8 -right-4 md:right-4 w-[212px] h-[380px] bg-[#0F172A] rounded-[38px] p-[6px] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.50)] z-20 border border-slate-700/60 ring-4 ring-slate-900/40 relative select-none"
              initial={shouldReduceMotion ? undefined : { opacity: 0, scale: 0.9, x: 35, y: 35 }}
              whileInView={shouldReduceMotion ? undefined : { opacity: 1, scale: 1, x: 0, y: 0 }}
              viewport={{ once: true, margin: "-60px" }}
              transition={shouldReduceMotion ? undefined : { type: "spring", damping: 20, stiffness: 100, delay: 0.35 }}
            ...
            >
              ...
              <div className="absolute left-[-2px] top-16 w-[2px] h-4 bg-slate-700/80 rounded-l-xs" />
              <div className="absolute left-[-2px] top-[90px] w-[2px].5 h-10 bg-slate-705 rounded-l-xs" />
              <div className="absolute left-[-2px] top-[140px] w-[2px].5 h-10 bg-slate-705 rounded-l-xs" />
              {/* Right Side: Power/Side Button */}
              <div className="absolute right-[-2px] top-[110px] w-[2px] h-[48px] bg-slate-705 rounded-r-xs" />
              ...
              <div className="bg-white rounded-[32px] p-3 text-brand-dark overflow-hidden h-full flex flex-col justify-between relative shadow-inner border border-gray-150/40 pt-7">
                ...
                <div className="absolute top-1.5 left-0 right-0 px-4.5 flex justify-between items-center text-[8.5px] font-sans font-semibold text-brand-dark/80 select-none z-40">
                  ...
                  <div className="flex items-center gap-1">
                    {/* Signal bars */}
                    <svg className="w-2.5 h-2" viewBox="0 0 10 8" fill="currentColor">
                    ...
                    {/* WiFi logo */}
                    <svg className="w-2.5 h-2" viewBox="0 0 10 8" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round">
                    ...
                    <div className="w-4 h-2 border border-brand-dark/70 rounded-xs p-[0.5px] flex items-center relative">
                      ...
                      <div className="absolute -right-[2px] top-[2px] w-[1px] h-1 bg-brand-dark/70 rounded-r-xs" />
                    </div>
                  </div>
                </div>
                ...
                <div className="flex justify-between items-center pb-2 border-b border-gray-100 text-[9px] text-brand-dark/40 pt-1">
                  <div className="flex items-center gap-1 font-mono font-medium">
                    ...
                    <span className="text-gray-500 font-sans tracking-wide">RestauCI Mobile</span>
                  </div>
                ...
                <div className="space-y-2 py-1.5 flex-1 flex flex-col justify-center">
                  <div className="flex justify-between items-center">
                    <span className="text-[10px] font-extrabold text-brand-dark tracking-tight">Aperçu Ventes</span>
                    <span className="text-[8.5px] bg-emerald-50 text-emerald-800 px-1.5 py-0.5 rounded font-bold">Aujourd'hui</span>
                  </div>
                  
                  {/* Huge Stat */}
                  <div className="bg-emerald-50/50 border border-emerald-500/10 p-2 rounded-xl text-center shadow-xs">
                    <h6 className="text-[8px] text-brand-dark/50 font-bold tracking-wider uppercase font-sans">Chiffre d'Affaires</h6>
                    <h4 className="text-base font-mono font-extrabold text-emerald-600 mt-0.5">1425,80 €</h4>
                  </div>
                  ...
                  <div className="space-y-1 text-[9px]">
                    <div className="flex justify-between border-b border-gray-50 pb-1">
                      ...
                      <span className="font-bold text-brand-dark font-mono">54 repas</span>
                    </div>
                    <div className="flex justify-between border-b border-gray-50 pb-1">
                      <span className="text-brand-dark/50">Panier moyen</span>
                      <span className="font-bold text-brand-dark font-mono">26.40 €</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-brand-dark/50">Livraisons</span>
                      <span className="font-bold text-emerald-600 font-mono">3 coursiers</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-auto space-y-1">
                  <div className="text-center pt-1.5 border-t border-gray-100 text-[8px] text-brand-dark/40 flex items-center justify-center gap-1 font-semibold">
                    <span className="uppercase tracking-widest text-[6.5px] text-gray-400">Sync • Temps Réel</span>
                  </div>
                  
                  {/* iPhone iOS Home Swipe Indicator bar */}
                  <div className="w-16 h-[3px] bg-gray-300 rounded-full mx-auto mt-2 mb-0.5" />
                </div>
