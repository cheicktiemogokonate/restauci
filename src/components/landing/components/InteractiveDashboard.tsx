...
const initialStocks = [
  ...
  {
    name: "Fromage Mozzarella di Bufala",
    qty: 5,
    max: 25,
    unit: "kg",
    status: "Critique",
  ...
  {
    name: "Frites fraîches épluchées",
    qty: 90,
    max: 150,
    unit: "kg",
    status: "Normal",
...
export default function InteractiveDashboard() {
  const [activeTab, setActiveTab] = useState<
    "dashboard" | "orders" | "stocks" | "tables"
  >("dashboard");
  ...
  const handleCreateOrder = (dishId: string) => {
    ...
    const newOrder = {
      ...
      table:
        "Table " + (tables.find((t) => t.status === "libre")?.label || "1"),
      items: `1x ${dish.name}`,
      amount: dish.price,
      status: "En Cuisine",
      time: "Maintenant",
  ...
  const criticalStockCount = stocks.filter(
    (s) => s.status === "Critique",
  ).length;
            ...
            >
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                <div className="bg-gray-50/50 p-3 sm:p-3.5 rounded-xl border border-gray-200/40">
                  ...
                  <div className="text-[10px] text-emerald-600 font-semibold flex items-center gap-1 mt-0.5 max-w-full overflow-hidden truncate">
                    ...
                    <span className="truncate">+18% Croissance</span>
                  </div>
                </div>
                ...
                <div className="bg-gray-50/50 p-3 sm:p-3.5 rounded-xl border border-gray-200/40">
                  <div className="flex items-center justify-between text-brand-dark/50 text-[11px] sm:text-xs font-medium">
                    ...
                    <ShoppingBag className="h-4 w-4 text-brand-green shrink-0" />
                  </div>
                  <div className="mt-1 text-base sm:text-xl font-mono font-bold text-brand-dark tracking-tight truncate">
                    {activeOrdersCount}
                  </div>
                  <div className="text-[10px] text-brand-dark/60 font-medium flex items-center gap-1 mt-0.5 max-w-full overflow-hidden truncate">
                    ...
                    <span className="truncate">Attente ~11m</span>
                  </div>
                </div>
                ...
                <div className="bg-gray-50/50 p-3 sm:p-3.5 rounded-xl border border-gray-200/40">
                  ...
                  <div className="text-[10px] text-amber-650 font-semibold flex items-center gap-1 mt-0.5 max-w-full overflow-hidden truncate">
                    ...
                    <span className="truncate">Proche rupture</span>
                  </div>
                </div>
                ...
                <div className="bg-gray-50/50 p-3 sm:p-3.5 rounded-xl border border-gray-200/40">
                  <div className="flex items-center justify-between text-brand-dark/50 text-[11px] sm:text-xs font-medium">
                    ...
                    <Users className="h-4 w-4 text-indigo-505 shrink-0" />
                  </div>
                  <div className="mt-1 text-base sm:text-xl font-mono font-bold text-brand-dark tracking-tight truncate">
                  ...
                  <div className="text-[10px] text-brand-dark/60 font-medium flex items-center gap-1 mt-0.5 max-w-full overflow-hidden truncate">
                    ...
                    <span className="truncate">
                      {occupiedTableCount} tables occupées
                    </span>
                  </div>
                </div>
              </div>
                ...
                <div className="bg-gray-50/30 p-4 rounded-xl border border-gray-200/40 lg:col-span-12 flex flex-col justify-between">
                  <div>
                    <div className="flex items-center justify-between pr-2">
                      <h4 className="text-sm font-semibold text-brand-dark/80">
                        Performance Financiére (Aujourd&apos;hui)
                      </h4>
                ...
                <div className="bg-gray-50/30 p-4 rounded-xl border border-gray-200/40 lg:col-span-12 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-[11px] text-brand-dark/60 mt-2 leading-relaxed">
                      Saisissez une commande simulée ci-dessous. Elle
                      s&apos;ajoutera automatiquement dans l&apos;écran de
                      cuisine ci-contre.
                    </p>
                  ...
                  <div className="mt-4 pt-3 border-t border-gray-100 flex justify-between items-center text-xs text-brand-dark/50">
                    ...
                    <span className="font-mono text-brand-dark/70">
                      Total : {orders.length}
                    </span>
                  </div>
                </div>
              ...
              <div className="bg-emerald-50/10 p-4 rounded-xl border border-brand-green/10">
                <div className="flex items-center justify-between pb-3 border-b border-brand-green/10 mb-3">
                  <h4 className="text-sm font-semibold text-brand-dark/90">
                    Suivi des Plats en un clin d&apos;œil
                  </h4>
                  <button
                    onClick={() => setActiveTab("orders")}
                    className="text-xs text-brand-green hover:underline flex items-center gap-0.5 font-bold"
                  >
                    Voir l&apos;écran de cuisine{" "}
                  ...
                  <table className="w-full text-left text-xs">
                    <thead>
                      <tr className="text-brand-dark/50 border-b border-gray-200/40 pb-2">
                        ...
                        <th className="py-2.5 font-medium font-mono text-center">
                          STATUT ACTUEL
                        </th>
                        <th className="py-2.5 font-medium text-right font-mono">
                          PRIX TOTAL
                        </th>
                      </tr>
                    </thead>
                    <tbody>
                      {orders.map((order) => (
                        ...
                        >
                          <td className="py-3 font-mono text-brand-dark/45">
                            #{order.id}
                          </td>
                          <td className="py-3 font-bold text-brand-dark">
                            {order.table}
                          </td>
                          <td className="py-3 text-brand-dark/80 break-words font-medium">
                            {order.items}
                          </td>
                            ...
                            <span
                              className={`inline-block px-2.5 py-1 rounded-full text-[10px] font-semibold ${
                                order.status === "Livré"
                                  ...
                                  : order.status === "Prêt"
                                    ? "bg-amber-500/10 text-amber-650 border border-amber-500/15"
              ...
              <div className="bg-gray-50/50 p-4 rounded-xl border border-gray-200/40">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 pb-3 border-b border-gray-200/30">
                  <div>
                    ...
                    <p className="text-xs text-brand-dark/60 mt-1">
                      ...
                      direct. Cliquez sur les boutons pour simuler
                      l&apos;avancement.
                    </p>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-5">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2 max-h-95 overflow-y-auto pr-1 [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-thumb]:bg-brand-green/20 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-transparent">
                      {orders.filter((o) => o.status === "En Cuisine")
                        .length === 0 ? (
                          ...
                          .map((order) => (
                            ...
                            >
                              <div className="flex justify-between items-center pb-2 border-b border-gray-100 mb-2">
                                ...
                                <span className="text-xs font-mono text-brand-dark/40 font-bold">
                                  #{order.id}
                                </span>
                              </div>
                              <p className="text-xs text-brand-dark/80 font-medium py-1 break-words">
                                {order.items}
                              </p>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2 max-h-95 overflow-y-auto pr-1 [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-thumb]:bg-amber-500/15 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-transparent">
                      {orders.filter((o) => o.status === "Prêt").length ===
                      0 ? (
                        <div className="text-center py-8 text-brand-dark/40 border border-dashed border-gray-200 rounded-lg text-xs">
                        ...
                        orders
                          ...
                          .map((order) => (
                            ...
                            >
                              ...
                              <p className="text-xs text-amber-800 py-1 font-medium break-words">
                                {order.items}
                              </p>
                              <div className="mt-3 flex justify-between items-center pt-2 border-t border-gray-100">
                                <span className="text-xs font-mono font-bold text-brand-dark">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2 max-h-95 overflow-y-auto pr-1 [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-thumb]:bg-emerald-600/15 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-transparent">
                      {orders.filter((o) => o.status === "Livré").length ===
                      0 ? (
                        <div className="text-center py-8 text-brand-dark/40 border border-dashed border-gray-200 rounded-lg text-xs">
                          ...
                          .map((order) => (
                            ...
                            >
                              <div className="flex justify-between items-center pb-2 border-b border-gray-100 mb-1">
                                <div>
                                  <span className="text-xs font-bold text-brand-dark/75">
                                    {order.table}
                                  </span>
                                </div>
                                <span className="text-xs font-mono text-brand-dark/45">
                                  #{order.id}
                                </span>
                              </div>
                              <p className="text-xs text-brand-dark/50 line-through py-1 break-words">
                                {order.items}
                              </p>
            ...
            >
              <div className="flex justify-between items-center pb-3 border-b border-gray-200/30 mb-4">
                <div>
                  ...
                  <p className="text-xs text-brand-dark/60 mt-1">
                    Visualisez les tables d&apos;un seul coup d&apos;œil.
                    Cliquez sur n&apos;importe quelle table pour changer son
                    statut de réservation (libre ➜ occupée ➜ réservée ➜ libre).
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-wrap items-center justify-center gap-6 pt-4 border-t border-gray-200/50 text-xs mt-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-brand-dark/70 font-medium">
                    Occupée (
                    {tables.filter((t) => t.status === "occupe").length})
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-brand-dark/70 font-medium">
                    Réservée (
                    {tables.filter((t) => t.status === "reserve").length})
                  </span>
                </div>
              </div>
            </motion.div>
