...
const ShapeGrid = ({
  ...
  useEffect(() => {
    ...
    const drawGrid = () => {
      ...
      // Add clean, high-contrast light background fading to match #FAFBFA
      ...
      gradient.addColorStop(0, "rgba(250, 251, 250, 0)");
      gradient.addColorStop(0.6, "rgba(250, 251, 250, 0.4)");
      gradient.addColorStop(1, "rgba(250, 251, 250, 0.95)");
