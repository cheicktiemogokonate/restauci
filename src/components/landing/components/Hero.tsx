...
export default function Hero() {
  ...
  return (
    <section
      id="hero"
      className="relative pt-[120px] pb-[80px] overflow-hidden bg-[#FAFBFA]"
    >
      ...
      <BackgroundDecoration
        ...
        className="absolute top-[480px] -right-25 opacity-20"
        size={310}
      />
      <BackgroundDecoration
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div
          ref={containerRef}
          className="text-center max-w-3xl mx-auto mb-14 flex flex-col items-center relative overflow-visible"
        >
          <BlurText
          ...
          >
            ...
            {/* <a
              href="#showcase"
              className="w-full sm:w-auto inline-flex items-center justify-center px-7 py-4 text-base font-bold text-brand-dark bg-white hover:bg-gray-50 rounded-xl border border-brand-border shadow-xs transition-all hover:-translate-y-0.5"
            >
