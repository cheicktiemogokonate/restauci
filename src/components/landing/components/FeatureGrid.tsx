...
export default function FeatureGrid() {
        ...
        return (
          <div className="space-y-3">
            <div className="flex items-center justify-between border-b border-gray-100 pb-2 mb-2">
              <span className="text-xs font-bold text-brand-dark/40 tracking-wider">
                FILE DE CUISINE
              </span>
            ...
            <div className="bg-[#FAFDF9] border border-brand-green/20 rounded-xl p-3 flex justify-between items-center shadow-xs">
              <div>
                <p className="text-xs font-bold text-brand-dark">
                  Table 4 — Burger Maison
                </p>
                <p className="text-[10px] text-brand-dark/50 font-mono">
                  1x Double Cheese, 1x Frites
                </p>
              </div>
              <span className="text-[10px] font-bold text-brand-green bg-brand-green/10 px-2 py-1 rounded">
                Prêt
              </span>
            </div>
            ...
            <div className="bg-white border border-gray-100 rounded-xl p-3 flex justify-between items-center shadow-xs">
              <div>
                <p className="text-xs font-bold text-brand-dark">
                  Table 2 — Salade César
                </p>
                <p className="text-[10px] text-brand-dark/50 font-mono">
                  2x Salade César, 1x Eau
                </p>
              </div>
            ...
            <div className="bg-white/50 border border-gray-100/50 rounded-xl p-3 flex justify-between items-center opacity-70">
              <div>
                ...
                <p className="text-[10px] text-brand-dark/40 font-mono">
                  1x Pizza Pepperoni, 1x Tiramisu
                </p>
              </div>
            ...
            <div className="space-y-3">
              <div>
                <div className="flex justify-between text-xs font-semibold mb-1">
                  ...
                  <span className="text-brand-dark/60 font-mono">
                    92/100 kg
                  </span>
                </div>
              ...
              <div>
                ...
                <div className="w-full bg-gray-100 h-2 rounded-full overflow-hidden">
                  <div
                    className="bg-red-500 h-full rounded-full animate-pulse"
                    style={{ width: "12.5%" }}
                  />
                </div>
              </div>
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-3 gap-2">
              <div className="border border-brand-green/20 bg-brand-green/5 rounded-lg p-2.5 text-center shadow-xs">
                <span className="block text-[10px] font-bold text-brand-dark/40">
                  T.1 (2p)
                </span>
                <span className="text-xs font-black text-brand-green block mt-1">
                  Libre
                </span>
              </div>
              <div className="border border-red-100 bg-red-50/30 rounded-lg p-2.5 text-center shadow-xs">
                ...
                <span className="text-xs font-black text-red-500 block mt-1">
                  Occupé
                </span>
              </div>
              <div className="border border-blue-100 bg-blue-50/20 rounded-lg p-2.5 text-center shadow-xs">
                ...
                <span className="text-xs font-black text-blue-500 block mt-1">
                  19:30
                </span>
              </div>
              <div className="border border-red-100 bg-red-50/30 rounded-lg p-2.5 text-center shadow-xs">
        ...
        return (
          <div className="space-y-4">
            <div className="flex items-center justify-between border-b border-gray-100 pb-2">
              ...
              <span className="text-xs font-bold text-brand-dark font-mono bg-gray-100 px-1.5 py-0.5 rounded">
                Aujourd&apos;hui
              </span>
            </div>
            ...
            <div className="space-y-2.5">
              <div className="flex justify-between items-center text-xs">
                <span className="text-brand-dark/60 font-medium">
                  Chiffre d&apos;Affaires
                </span>
              ...
              <div className="flex justify-between items-center text-xs">
                <span className="text-brand-dark/60 font-medium font-sans">
                  Panier Moyen
                </span>
              ...
              <div className="flex justify-between items-center text-xs border-t border-dashed border-gray-100 pt-2.5">
                <span className="text-brand-dark/60 font-semibold text-[10px] uppercase">
                  Top Ventes
                </span>
  ...
  return (
    <section
      id="features"
      className="py-24 bg-white border-y border-[#EAEAEA] relative overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-sm sm:text-base text-brand-dark/70 font-sans leading-relaxed max-w-2xl mx-auto">
            Gagnez un temps précieux, simplifiez les opérations de vos équipes
            et maximisez l&apos;efficacité opérationnelle de votre cuisine.
          </p>
        </div>
        ...
        <div className="w-full relative">
          ...
          >
            {featureGridData.map((feature, idx) => (
              <ScrollStackItem
                key={feature.id}
                itemClassName="!p-0 !h-auto !bg-transparent !shadow-none"
              >
                <div
                        ...
                        {idx === 0 && (
                          <>
                            <li className="flex items-center gap-2 text-xs font-medium text-brand-dark/75">
                              ...
                              Écrans tactiles synchronisés
                            </li>
                            <li className="flex items-center gap-2 text-xs font-medium text-brand-dark/75">
                              <Check className="h-4 w-4 text-brand-green" />{" "}
                              Option emporter / livraison instantanée
                            </li>
                            <li className="flex items-center gap-2 text-xs font-medium text-brand-dark/75">
                              <Check className="h-4 w-4 text-brand-green" />{" "}
                              Billetterie cuisine dynamique
                            </li>
                          </>
                        )}
                        {idx === 1 && (
                          <>
                            <li className="flex items-center gap-2 text-xs font-medium text-brand-dark/75">
                              <Check className="h-4 w-4 text-brand-green" />{" "}
                              Décompte d&apos;ingrédients à la portion
                            </li>
                            <li className="flex items-center gap-2 text-xs font-medium text-brand-dark/75">
                              <Check className="h-4 w-4 text-brand-green" />{" "}
                              Alertes de rupture instantanées
                            </li>
                            <li className="flex items-center gap-2 text-xs font-medium text-brand-dark/75">
                              <Check className="h-4 w-4 text-brand-green" />{" "}
                              Commande fournisseurs assistée par IA
                            </li>
                          </>
                        )}
                        {idx === 2 && (
                          <>
                            ...
                            <li className="flex items-center gap-2 text-xs font-medium text-brand-dark/75">
                              <Check className="h-4 w-4 text-brand-green" />{" "}
                              Plan de salle coloré et vivant
                            </li>
                            <li className="flex items-center gap-2 text-xs font-medium text-brand-dark/75">
                              <Check className="h-4 w-4 text-brand-green" />{" "}
                              Rappels par SMS automatiques
                            </li>
                          </>
                        )}
                        {idx === 3 && (
                          <>
                            <li className="flex items-center gap-2 text-xs font-medium text-brand-dark/75">
                              <Check className="h-4 w-4 text-brand-green" />{" "}
                              Graphiques de performances directs
                            </li>
                            <li className="flex items-center gap-2 text-xs font-medium text-brand-dark/75">
                              <Check className="h-4 w-4 text-brand-green" />{" "}
