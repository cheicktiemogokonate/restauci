...
export const benefitsData: Benefit[] = [
  {
    ...
    description: "Déployez votre caisse et votre gestion de cuisine en moins de 15 minutes, sans complexité technique.",
  },
  {
    id: "b2",
    iconName: "Heart",
    title: "Suivi de la satisfaction",
    description: "Améliorez l'expérience client grâce à des rapports clairs et un suivi en temps réel.",
  },
  {
    id: "b3",
    iconName: "Trash2",
    title: "Zéro gaspillage",
    description: "Réduisez le gaspillage alimentaire avec des alertes de stock et des prévisions de consommation.",
  },
  {
    id: "b4",
    iconName: "TrendingUp",
    title: "Croissance mesurable",
    description: "Augmentez votre chiffre d'affaires grâce à une gestion optimisée des commandes et des promotions.",
  },
];
...
export const featureGridData: FeatureGridItem[] = [
  {
    ...
    description: "Gérez votre carte, vos plats et vos offres spéciales depuis un seul tableau de bord intuitif.",
  },
  {
    id: "f2",
    iconName: "Layers",
    title: "Gestion intelligente des stocks",
    description: "Anticipez les ruptures et gérez vos approvisionnements avant que les ingrédients ne manquent.",
  },
  {
    id: "f3",
    iconName: "Calendar",
    title: "Réservations et salle",
    description: "Pilotez vos réservations, votre plan de salle et votre service depuis une interface claire.",
  },
  {
    id: "f4",
    iconName: "BarChart3",
    title: "Tableaux de bord opérationnels",
    description: "Visualisez vos performances, vos marges et vos ventes en temps réel pour prendre des décisions rapides.",
  },
];
...
export const testimonialData: Testimonial[] = [
  {
    ...
    avatar: "https://images.unsplash.com/photo-1502685104226-ee32379fefbe?w=100&h=100&fit=crop&q=80",
    name: "Céline R.",
    role: "Gérante",
...
export const dishesData: Dish[] = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=400&h=400&fit=crop&q=80",
    price: 9.8,
    rating: 4.6,
    category: "Desserts",
    salesCount: 76,
