...
export interface IphoneProps extends HTMLAttributes<HTMLDivElement> {
  src?: string
  videoSrc?: string
  /** Live content rendered inside the Magic UI screen aperture. */
  children?: ReactNode
}
