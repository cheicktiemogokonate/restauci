...
export interface SafariProps extends HTMLAttributes<HTMLDivElement> {
  ...
  videoSrc?: string
  mode?: SafariMode
  /** Live content rendered inside the Magic UI browser viewport. */
  children?: ReactNode
}
...
export function Safari({
  ...
  return (
    <div
      ...
      {...props}
    >
      <div className="safari-mobile-toolbar" aria-hidden="true">
        <span className="safari-mobile-dots"><i /><i /><i /></span>
        <span className="safari-mobile-url">{url}</span>
      </div>
      {hasVideo && (
        <div
          className="safari-viewport pointer-events-none absolute z-0 overflow-hidden"
          style={{
            left: `${LEFT_PCT}%`,
            top: `${TOP_PCT}%`,
            width: `${WIDTH_PCT}%`,
      ...
      {!hasVideo && !imageSrc && children && (
        <div
          className="safari-viewport absolute z-0 overflow-hidden rounded-b-[11px]"
          style={{
            left: `${LEFT_PCT}%`,
            top: `${TOP_PCT}%`,
            width: `${WIDTH_PCT}%`,
      ...
      <svg
        ...
        className="safari-frame-svg absolute inset-0 z-10 size-full"
