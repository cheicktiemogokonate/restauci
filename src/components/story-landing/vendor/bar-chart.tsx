...
/**
 * Animata — Bar Chart (https://animata.design, open source).
 * Source : codse/animata · animata/graphs/bar-chart.tsx
 *
 * Seule adaptation : l'utilitaire cn pointe vers l'alias partagé du dépôt.
 */
        ...
        return (
          ...
          >
            <div
              ...
              className={cn("transition-all duration-700 ease-out", item.className)}
            />
          </div>
        );
      })}
