...
// Le timeout client reste volontairement aligné sur le service de géocodage.
// Non importée car ce module est client ("use client" via delivery-map.tsx)
// et geo/index.ts importe @/infrastructure/logger (pino + @/infrastructure/env) — un import
